...
`docs/проект/теория_корабля.md` и на растровых листах `renders/…/расчёты/`.
  ...
  РТ-04  остойчивость - пантокарены, ДСО, ДДО, нормы РКО
...
def rt04():
    ...
    заголовок(msp, "Остойчивость на больших углах крена - пантокарены, ДСО, ДДО и нормы РКО")
    x = 40
    ...
    ЧД.text(msp, 40, 262, "Нормы остойчивости Российского классификационного общества, класс «%s»" % H.CLASS, 3.5, 1, "08_ТЕКСТ", TA.BOTTOM_LEFT)
