...
fig.suptitle("Шлюпочный пост   ·   ВГ-2026.15.00 ВО", fontsize=17,
             fontweight="bold", x=0.012, ha="left", y=0.982)
fig.text(0.012, 0.952,
         "Площадка спонсона на кницах, шлюпка на 100 человек, гравитационная "
         "шлюпбалка, кильблоки, съёмное ограждение и посадочная площадка. "
         "Шесть постов на судне, по три на борт",
...
# ------------------------------------------------ вид с борта ---------------
ax = fig.add_axes([0.030, 0.600, 0.455, 0.315])
...
# ------------------------------------------------ план ----------------------
ax2 = fig.add_axes([0.515, 0.600, 0.455, 0.315])
...
# ------------------------------------------------ сечение по книце ----------
ax3 = fig.add_axes([0.030, 0.300, 0.205, 0.250])
...
# ------------------------------------------------ спецификация --------------
ax4 = fig.add_axes([0.300, 0.040, 0.690, 0.515])
ax4.axis("off")
...
ax5 = fig.add_axes([0.030, 0.035, 0.245, 0.245])
