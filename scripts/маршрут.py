...
АТРИБУЦИЯ_OSM = "Подложка - © участники OpenStreetMap (ODbL). Реки - Natural Earth. Положение мостов и шлюзов - приближённое, высоты - по таблице мостов маршрута."
...
АТРИБУЦИЯ_ЯНДЕКС = "Подложка - скриншот Яндекс Карт, © Яндекс. Реки - Natural Earth. Положение мостов и шлюзов - приближённое, высоты - по таблице мостов маршрута."
...
def карта_схема(путь, плечи, пересчитать=False):
    ...
    d.text((lx + 24, y + 4), "приход и отход у порта - по расписанию рейса;", font=font(22), fill=(60, 70, 90)); y += 30
