...
VIEWS = [
    ...
    ("05_шлюпочный_променад",
     (L * 0.26, 7.45, DK["шлюпочная"] + 1.62),
     (L * 0.86, 7.45, DK["шлюпочная"] + 1.05), 24.0),
    ("06_солнечная_палуба",
     (L * 0.34, -1.30, DK["солнечная"] + 1.62),
     (L * 0.80, 1.00, DK["солнечная"] + 1.05), 24.0),
    ("07_главная_палуба_променад",
     (L * 0.20, 7.55, DK["главная"] + 1.62),
     (L * 0.84, 7.45, DK["главная"] + 1.05), 24.0),
    ("08_вид_сверху",
