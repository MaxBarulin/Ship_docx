...
WEIGHT_GROUPS = [
    ...
    ("Изоляция и зашивка, первая",          40.0,  10.0, 118.0,  1.80,   0.0),
    ("Изоляция и зашивка, главная",         55.0,   9.0, 121.0,  4.20,   0.0),
    ("Изоляция и зашивка, средняя",         55.0,   9.0, 121.0,  7.00,   0.0),
    ("Оборудование помещений, первая",      80.0,  10.0, 118.0,  1.90,   0.0),
    ("Оборудование помещений, главная",    140.0,   9.0, 121.0,  4.30,   0.0),
    ("Оборудование помещений, средняя",    130.0,   9.0, 121.0,  7.10,   0.0),
    ("Якорно-швартовное устройство",        24.0, 108.0, 126.0,  3.60,   0.0),
    ("Спасательные средства",               48.0,  30.0, 100.0,  8.80,   0.0),
    ("Системы и трубопроводы",              180.0,   4.0, 124.0,  3.40,   0.0),
    ...
    ("Запас водоизмещения 3 %",              70.0,   0.0, 128.0,  3.50,   0.0),
    ...
    ("СПГ 130 м3",                           58.5,  14.0,  34.0,  9.60,   0.0),
    ("Запальное топливо 12 м3",              10.3,  20.0,  24.0,  0.50,   6.0),
    ("Пресная вода 110 м3",                 110.0,  60.0,  96.0,  0.50,  40.0),
    ...
    ("Провизия и снабжение",                 34.0,  40.0,  52.0,  1.50,   0.0),
