...
справа. Этот модуль даёт им ту же форму, что и у DXF.
    ...
    sh = eskd.Sheet("A1", mark="ВГ-2026.46.00 СБ",
                    name="Фундамент-замок\\nмодуля",
                    material="",
                    mass=31.9, scale="1:1")
...
plt.rcParams["axes.unicode_minus"] = False     # минус в подписях осей - обычный дефис
...
#: Графы подписей основной надписи; фамилии не вписываются - лист подписывают от руки.
PEOPLE = [("Разраб.", ""),
          ("Пров.", ""),
          ("Т. контр.", ""),
          ("Н. контр.", ""),
