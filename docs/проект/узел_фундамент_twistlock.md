...
Масса стальных деталей узла - 24,20 кг против 24,52 кг в модели МКЭ (расхождение -1,3 %), центр тяжести на высоте Z = -39,0 мм против -41,4. Размеры платика и запора подобраны по массе, центру тяжести и моментам инерции модели МКЭ и по отверстию фитинга ISO 1161.
...
Расчёт МКЭ выполнен для узла в сборе на принятых материалах - корпус 20ГСЛ, платик 09Г2С, запор 40Х (раздел 4.2). Наименьший запас по текучести корпуса 20ГСЛ при 33,1 кН - 3,83. Запас пропорционален пределу текучести, поэтому для других марок корпуса при той же геометрии он равен 3,83 × σт / 294. Сравнение материалов для корпуса:

| Материал | Стандарт | σт, МПа | σв, МПа | δ, % | KCU, кДж/м² | Литьё | Сварка | Цена, отн. | Запас при 33,1 кН | Запас при 88,5 кН | Вывод |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 20Л | ГОСТ 977-88 | 216 | 412 | 22 | 491 | хорошие | хорошая | 1,00 | 2,81 | 1,05 | запас по текучести на 27 % ниже 20ГСЛ, эксплуатационный случай не проходит |
| 25Л | ГОСТ 977-88 | 235 | 441 | 19 | 392 | хорошие | удовлетворительная | 1,02 | 3,06 | 1,14 | ниже ударная вязкость, а узел работает на удар - посадка модуля краном |
| 20ГЛ | ГОСТ 977-88 | 275 | 540 | 18 | 491 | хорошие | хорошая | 1,06 | 3,58 | 1,34 | близка к 20ГСЛ, но предел текучести на 6 % ниже |
| 20ГСЛ | ГОСТ 977-88 | 294 | 540 | 18 | 491 | хорошие | хорошая | 1,10 | 3,83 | 1,43 | принято. Самая прочная из свариваемых литых сталей без закалки, судовое литьё, приварка к платику и заварка дефектов без подогрева |
| 35ХГСЛ | ГОСТ 977-88 | 343 | 590 | 14 | 294 | удовлетворительные | плохая | 1,35 | 4,46 | 1,67 | прочнее, но ударная вязкость ниже на 40 %, сварка с подогревом и повторной термообработкой |
| ВЧ 50 | ГОСТ 7293-85 | 320 | 500 | 7 | - | отличные | не сваривается | 0,85 | 4,16 | 1,56 | к платику не приварить, удлинение 7 %, хрупкость при ударе на морозе |
| 09Г2С | ГОСТ 19281-2014 | 300 | 450 | 21 | - | не льётся | хорошая | - | 3,90 | 1,46 | марки для литья в ГОСТ 977-88 нет. Корпус из проката - сварная конструкция из многих деталей |
| ВСт3сп5 | ГОСТ 14637-89 | 225 | 450 | 26 | - | не льётся | хорошая | - | 2,93 | 1,09 | то же, предел текучести на 23 % ниже 20ГСЛ |
...
Модули тяжелее 10 т ставятся только в ряд ДП - в бортовом ряду к вертикальному ускорению от качки добавляется ε·y, и бассейн 13,5 т дал бы на опору 106,7 кН с запасом по МКЭ 1,19 при нужном 1,25, а в ДП - 88,5 кН и запас 1,43. Во всех темах бассейн стоит в ДП, предел по массе в бортовом ряду - 12,8 т.
...
Узел в сборе рассчитан в APM FEM для КОМПАС-3D v25. Расчётное ядро - APM Structure3D, аттестационный паспорт программы для ЭВМ № 488 от 19.12.2019, Ростехнадзор. Материалы модели - как в спецификации, свойства - из библиотеки программы.

| Параметр | Значение |
|---|---|
| Материалы | корпус 20ГСЛ, платик 09Г2С, запор 40Х |
| Масса модели | 24,52 кг |
| Центр тяжести | 0,31; 2,64; -41,42 мм |
...
| Закрепления | две группы - 8 граней и 10 рёбер по UX, UY, UZ, суммарная реакция 33 100 Н равна нагрузке |
| Эквивалентное напряжение по Мизесу | до 191,8 МПа |
| Суммарное перемещение | до 0,0028 мм |
| Запас по пределу текучести | не ниже 3,83, на боковой грани корпуса |
| Запас по пределу прочности | не ниже 6,93 |

![Расчёт МКЭ, коэффициент запаса по пределу текучести](../../renders/горизонт_2026/узел/46_04_мкэ_запас.png)

*Расчёт МКЭ, коэффициент запаса по пределу текучести*

![Расчёт МКЭ, суммарные перемещения, мм](../../renders/горизонт_2026/узел/46_05_мкэ_перемещения.png)

*Расчёт МКЭ, суммарные перемещения, мм*

![Расчёт МКЭ, суммарные перемещения, вид со стороны рукоятки](../../renders/горизонт_2026/узел/46_06_мкэ_перемещения_рукоятка.png)

*Расчёт МКЭ, суммарные перемещения, вид со стороны рукоятки*

Наименьшему запасу по текучести корпуса отвечает напряжение 294 / 3,83 = 76,9 МПа, по прочности запас 6,93. На расчётное сжатие запас пересчитывается линейно, n = 3,83 × 33,1 / P:

| Случай | Сжатие P, кН | Запас n | Нужно | Напряжение, МПа |  |
|---|---|---|---|---|---|
| Эксплуатация | 65,0 | 1,95 | 1,67 | 150,9 | ок |
| Предельный | 88,5 | 1,43 | 1,25 | 205,7 | ок |
| Посадка краном | 99,3 | 1,28 | 1,25 | 230,8 | ок |
...
| Масса модели - против отчёта МКЭ | 24,2 | 24,52 | ок | корпус 7,55 по 3D, платик 14,93, запор 1,45, стержень 0,15, шайба 0,12, расхождение -1,3 % |
| Центр тяжести по высоте - против МКЭ | -39,03 | -41,42 | ок | платик под полосами хвоста, Z -66…-46 |
...
| Порог правила размещения ниже предела по МКЭ | 10 | 12,82 | ок | модули тяжелее 10 т - только в ряду ДП. В бортовом ряду запас 1,25 держится до 12,8 т |
| Корпус и платик - напряжение по МКЭ (эксплуатация) | 150,9 | 176,4 | ок | запас 1,17, сжатие 65,0 кН против 33,1 в отчёте МКЭ, запас по текучести 20ГСЛ 1,95 при нужном 1,67 |
| Корпус и платик - напряжение по МКЭ (предельный) | 205,7 | 235,2 | ок | запас 1,14, сжатие 88,5 кН против 33,1 в отчёте МКЭ, запас по текучести 20ГСЛ 1,43 при нужном 1,25 |
| Корпус и платик - напряжение по МКЭ (посадка) | 230,8 | 235,2 | ок | запас 1,02, сжатие 99,3 кН против 33,1 в отчёте МКЭ, запас по текучести 20ГСЛ 1,28 при нужном 1,25 |
