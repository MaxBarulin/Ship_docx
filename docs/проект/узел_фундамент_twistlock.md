...
Команда 22.09.2026 взяла узлом КД фундамент для крепления модульных номеров солнечной палубы. Основа — эскизный 3D-проект узла (`docs/команда/солнечная_палуба/Чертёж крепления.jpg`): литой корпус на болтах и поворотный конус с рукояткой. Узел держит «трансформер» — 8 модулей на 18 слотах, 72 фундаментов на судно (`gorizont_modules`).
...
|---|---|---|---|---|---|
| РКД узла: чертежи, спецификация, расчёт — согласование с РРР | 08.01.2027 | 04.02.2027 | 20 | ПБ | в составе РКД |
| ТП литья, мехобработки и сборки; управляющие программы ЧПУ | 05.02.2027 | 25.02.2027 | 15 | ТУ, ЛЦ, МЦ |  |
| Модельный комплект и стержневой ящик | 03.08.2027 | 30.08.2027 | 20 | модельный участок ЛЦ | задача 7.4 карты постройки |
...
| Серийная партия: 71 отливок | 01.10.2027 | 28.10.2027 | 20 | ЛЦ | задача 10.4 карты постройки |
...
| Фундаменты готовы до достройки | 02.12.2027 | 05.02.2029 | ок | серия собрана и испытана до начала достройки по карте постройки |
